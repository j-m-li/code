/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32x035_spi.h Author :
...
typedef struct {
	...
	uint16_t SPI_CPOL; /* Specifies the serial clock steady state.
			      This parameter can be a value of @ref
			      SPI_Clock_Polarity When using SPI slave mode to
			      send data, the CPOL bit should be set to 1 */
	...
	uint16_t
	    SPI_BaudRatePrescaler; /* Specifies the Baud Rate prescaler value
...
#define SPI_CPOL_High                                                          \
	((uint16_t)0x0002) // When using SPI slave mode to send data, the CPOL

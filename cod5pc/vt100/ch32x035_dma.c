/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32x035_dma.c Author :
 ...
 * @return  none
 */
void DMA_ClearFlag(uint32_t DMAy_FLAG) { DMA1->INTFCR = DMAy_FLAG; }
 ...
 * @return  none
 */
void DMA_ClearITPendingBit(uint32_t DMAy_IT) { DMA1->INTFCR = DMAy_IT; }

/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32x035_gpio.c Author :
 *WCH Version            : V1.0.0 Date               : 2024/08/06 Description :
...
void GPIO_Init(GPIO_TypeDef *GPIOx, GPIO_InitTypeDef *GPIO_InitStruct) {
	...
	if (((uint32_t)GPIO_InitStruct->GPIO_Pin & ((uint32_t)0x0000FF)) !=
	    0x00) {
		tmpreg = GPIOx->CFGLR;
	...
	if (((uint32_t)GPIO_InitStruct->GPIO_Pin & ((uint32_t)0x00FF00)) !=
	    0x00) {
 ...
 *            GPIO_PartialRemap1_USART1 - USART1 Partial1 Alternate Function
 * mapping GPIO_PartialRemap2_USART1 - USART1 Partial2 Alternate Function
 * mapping GPIO_FullRemap_USART1 - USART1 Full Alternate Function mapping
 *            GPIO_PartialRemap1_USART2 - USART2 Partial1 Alternate Function
 * mapping GPIO_PartialRemap2_USART2 - USART2 Partial2 Alternate Function
 * mapping GPIO_PartialRemap3_USART2 - USART2 Partial3 Alternate Function
 * mapping GPIO_FullRemap_USART2 - USART2 Full Alternate Function mapping
 *            GPIO_PartialRemap1_USART3 - USART3 Partial1 Alternate Function
 * mapping GPIO_PartialRemap2_USART3 - USART3 Partial2 Alternate Function
 * mapping GPIO_FullRemap_USART3 - USART3 Full Alternate Function mapping
 *            GPIO_PartialRemap1_USART4 - USART4 Partial1 Alternate Function
 * mapping GPIO_PartialRemap2_USART4 - USART4 Partial2 Alternate Function
 * mapping GPIO_PartialRemap3_USART4 - USART4 Partial3 Alternate Function
 * mapping GPIO_PartialRemap4_USART4 - USART4 Partial4 Alternate Function
 * mapping GPIO_PartialRemap5_USART4 - USART4 Partial5 Alternate Function
 * mapping GPIO_PartialRemap6_USART4 - USART4 Partial6 Alternate Function
	...
	if ((GPIO_Remap & 0x08000000) == 0x08000000) /* 3bit */
	{
		if ((GPIO_Remap &
		    ...
		    (DBGAFR_LOCATION_MASK |
		     DBGAFR_NUMBITS_MASK)) /* [26:24] SDI */
		{
			tmpreg &= DBGAFR_SWJCFG_MASK;
			AFIO->PCFR1 &= DBGAFR_SWJCFG_MASK;
		} else if ((GPIO_Remap & DBGAFR_TIM1RP_MASK) ==
			   DBGAFR_TIM1RP_MASK) /* [31:16] 3bit */
		{
			...
			return;
			    ...
			    (DBGAFR_LOCATION_MASK | DBGAFR_NUMBITS_MASK)) ==
			   DBGAFR_LOCATION_MASK) /* [31:16] 3bit */
		{
		...
		if ((GPIO_Remap &
		     (DBGAFR_LOCATION_MASK | DBGAFR_NUMBITS_MASK)) ==
		    (DBGAFR_LOCATION_MASK |
		     DBGAFR_NUMBITS_MASK)) /* [31:16] 2bit */
		{
		...
		} else /* [31:0] 1bit */
		{
			tmpreg &=
			    ~(tmp
			      << (((GPIO_Remap & 0x00FFFFFF) >> 0x15) * 0x10));
		}
	}
 ...
 * EXTI lines. This parameter can be GPIO_PortSourceGPIOx where x can be (A..C).
...
void GPIO_EXTILineConfig(uint8_t GPIO_PortSource, uint16_t GPIO_PinSource) {
	...
	AFIO->EXTICR[GPIO_PinSource >> 0x04] |=
	    (((uint32_t)GPIO_PortSource)
	     << (0x02 * (GPIO_PinSource & (uint8_t)0x0F)));
}
...
void GPIO_IPD_Unused(void) {
	...
	{
		GPIO_InitStructure.GPIO_Pin =
		    GPIO_Pin_16 | GPIO_Pin_15 | GPIO_Pin_17 | GPIO_Pin_18 |
		    GPIO_Pin_19 | GPIO_Pin_20 | GPIO_Pin_21 | GPIO_Pin_22 |
		    GPIO_Pin_23 | GPIO_Pin_14 | GPIO_Pin_8 | GPIO_Pin_9 |
		    GPIO_Pin_10 | GPIO_Pin_11 | GPIO_Pin_12 | GPIO_Pin_13;
		GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
		GPIO_Init(GPIOA, &GPIO_InitStructure);
		GPIO_InitStructure.GPIO_Pin =
		    GPIO_Pin_2 | GPIO_Pin_13 | GPIO_Pin_14 | GPIO_Pin_15 |
	...
	case 0x035E0600: // CH32X035F8U6
	{
		GPIO_InitStructure.GPIO_Pin =
		    GPIO_Pin_16 | GPIO_Pin_15 | GPIO_Pin_17 | GPIO_Pin_18 |
		    GPIO_Pin_19 | GPIO_Pin_20 | GPIO_Pin_21 | GPIO_Pin_22 |
		    GPIO_Pin_23 | GPIO_Pin_8 | GPIO_Pin_9 | GPIO_Pin_10 |
		    GPIO_Pin_11 | GPIO_Pin_12 | GPIO_Pin_13 | GPIO_Pin_14;
		GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
		GPIO_Init(GPIOA, &GPIO_InitStructure);
		GPIO_InitStructure.GPIO_Pin =
		    GPIO_Pin_2 | GPIO_Pin_9 | GPIO_Pin_4 | GPIO_Pin_5 |
		    GPIO_Pin_6 | GPIO_Pin_7 | GPIO_Pin_8 | GPIO_Pin_10 |
		    GPIO_Pin_16 | GPIO_Pin_15 | GPIO_Pin_14 | GPIO_Pin_13 |
		    GPIO_Pin_17 | GPIO_Pin_18 | GPIO_Pin_19 | GPIO_Pin_20 |
		    GPIO_Pin_21;
		GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
		GPIO_Init(GPIOB, &GPIO_InitStructure);
		GPIO_InitStructure.GPIO_Pin =
	...
	case 0x03117000: // CH32X033F8P6
	{
		GPIO_InitStructure.GPIO_Pin =
		    GPIO_Pin_16 | GPIO_Pin_15 | GPIO_Pin_17 | GPIO_Pin_18 |
		    GPIO_Pin_19 | GPIO_Pin_20 | GPIO_Pin_21 | GPIO_Pin_22 |
		    GPIO_Pin_23 | GPIO_Pin_8 | GPIO_Pin_12 | GPIO_Pin_13 |
		    GPIO_Pin_14;
		GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
		GPIO_Init(GPIOA, &GPIO_InitStructure);
		GPIO_InitStructure.GPIO_Pin =
		    ...
		    GPIO_Pin_11 | GPIO_Pin_12 | GPIO_Pin_13 | GPIO_Pin_14 |
		    GPIO_Pin_15 | GPIO_Pin_16 | GPIO_Pin_17 | GPIO_Pin_18 |
		    GPIO_Pin_19 | GPIO_Pin_20 | GPIO_Pin_21 | GPIO_Pin_22 |
		    GPIO_Pin_23;
		GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
		GPIO_Init(GPIOB, &GPIO_InitStructure);
		GPIO_InitStructure.GPIO_Pin =
		    ...
		    GPIO_Pin_15 | GPIO_Pin_20 | GPIO_Pin_21 | GPIO_Pin_22 |
		    GPIO_Pin_23;
		GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
		GPIO_Init(GPIOC, &GPIO_InitStructure);
		break;

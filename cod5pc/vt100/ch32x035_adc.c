/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32x035_adc.c Author :
 ...
 * channel. ADC_SampleTime_4Cycles - Sample time equal to 4 cycles.
 ...
 * selected. ADC_ExternalTrigInjecConv_T2_CC3 - Timer2 capture compare3
 * selected. ADC_ExternalTrigInjecConv_T2_CC4 - Timer2 capture compare4
 * selected. ADC_ExternalTrigInjecConv_T2_CC2 - Timer2 capture compare2
 * selected. ADC_ExternalTrigInjecConv_T3_CC2 - Timer3 capture compare2
 * selected. ADC_ExternalTrigInjecConv_ADC_ETRGREG - ADC ETRGREG selected.

/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32x035_exti.h Author :
...
typedef struct {
	uint32_t EXTI_Line; /* Specifies the EXTI lines to be enabled or
			       disabled. This parameter can be any combination
			       of @ref EXTI_Lines */
	...
	EXTITrigger_TypeDef
	    EXTI_Trigger; /* Specifies the trigger signal active edge for the
			     EXTI lines. This parameter can be a value of @ref
			     EXTIMode_TypeDef */

	FunctionalState EXTI_LineCmd; /* Specifies the new state of the selected
					 EXTI lines. This parameter can be set
...
#define EXTI_Line24                                                            \
	((uint32_t)0x01000000) /* External interrupt line 24 Connected to the  \
				  PC18(SDI on) */
#define EXTI_Line25                                                            \
	((uint32_t)0x02000000) /* External interrupt line 25 Connected to the  \
				  PC19(SDI on) */
#define EXTI_Line26                                                            \
	((uint32_t)0x04000000) /* External interrupt line 26 Connected to the  \
				  PVD Output */
#define EXTI_Line27                                                            \
	((uint32_t)0x08000000) /* External interrupt line 27 Connected to the  \
				  Auto Wake-up event */
#define EXTI_Line28                                                            \
	((uint32_t)0x10000000) /* External interrupt line 28 Connected to the  \
				  the USBFS Wake-up event */
#define EXTI_Line29                                                            \
	((uint32_t)0x20000000) /* External interrupt line 29 Connected to the  \
				  the USB PD Wake-up event */

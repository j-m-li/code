 ...
 * Version            : V1.0.2
 * Date               : 2025/03/10
 * Description        : RISC-V V4 Core Peripheral Access Layer Header File for
 *CH32X035
 *********************************************************************************
 ...
 * @return  none
 */
__attribute__((always_inline)) RV_STATIC_INLINE void
...
NVIC_GetStatusIRQ(IRQn_Type IRQn) {
 ...
 */
__attribute__((always_inline)) RV_STATIC_INLINE void
NVIC_SetPriority(IRQn_Type IRQn, uint8_t priority) {
 ...
 * @return  none
 */
__attribute__((always_inline)) RV_STATIC_INLINE void __WFI(void) { __WFE(); }
 ...
 */
__attribute__((always_inline)) RV_STATIC_INLINE void
SetVTFIRQ(uint32_t addr, IRQn_Type IRQn, uint8_t num,
 ...
 */
__attribute__((always_inline)) RV_STATIC_INLINE int32_t
 ...
 *          Atomically signed max compare 32bit value with value in memory using
 * amomax.d.
 *
 * @param   addr - Address pointer to data, address need to be 4byte aligned
 ...
 *          Atomically unsigned max compare 32bit value with value in memory
 * using amomaxu.d.
 *
 * @param   addr - Address pointer to data, address need to be 4byte aligned
 *          value - value to be compared
 ...
 */
__attribute__((always_inline)) RV_STATIC_INLINE uint32_t
__AMOMAXU_W(volatile uint32_t *addr, uint32_t value) {
	uint32_t result;
 ...
 *          Atomically signed min compare 32bit value with value in memory using
 * amomin.d.
 *
 * @param   addr - Address pointer to data, address need to be 4byte aligned
 *          value - value to be compared
 ...
 *          Atomically unsigned min compare 32bit value with value in memory
 * using amominu.d.
 *
 * @param   addr - Address pointer to data, address need to be 4byte aligned
 *          value - value to be compared
 ...
 */
__attribute__((always_inline)) RV_STATIC_INLINE uint32_t
__AMOMINU_W(volatile uint32_t *addr, uint32_t value) {
	uint32_t result;
 ...
 */
__attribute__((always_inline)) RV_STATIC_INLINE uint32_t
__AMOSWAP_W(volatile uint32_t *addr, uint32_t newval) {
	uint32_t result;
 ...
 */
__attribute__((always_inline)) RV_STATIC_INLINE int32_t
__AMOXOR_W(volatile int32_t *addr, int32_t value) {
	int32_t result;

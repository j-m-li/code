/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32x035_misc.h Author :
...
#define INTSYSCR_INEST_NoEN                                                    \
	0x00 /* interrupt nesting disable(CSR-0x804 bit1 = 0) */
#define INTSYSCR_INEST_EN                                                      \
	0x01 /* interrupt nesting enable(CSR-0x804 bit1 = 1) */
...
#define NVIC_PriorityGroup_0                                                   \
	((uint32_t)0x00) /* interrupt nesting disable(CSR-0x804 bit1 = 0) */
#else
#define NVIC_PriorityGroup_1                                                   \
	((uint32_t)0x01) /* interrupt nesting enable(CSR-0x804 bit1 = 1) */
#endif

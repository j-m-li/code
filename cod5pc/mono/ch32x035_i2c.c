/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32x035_i2c.c Author :
 *WCH Version            : V1.0.0 Date               : 2024/03/19 Description :
 ...
 * operation to I2C_STAR1 register (I2C_GetFlagStatus()) followed by a write
 * operation to I2C_CTLR1 register (I2C_Cmd() to re-enable the I2C peripheral).
 *           - ADD10 (10-bit header sent) is cleared by software sequence: a
 * read operation to I2C_SATR1 (I2C_GetFlagStatus()) followed by writing the
 *             second byte of the address in DATAR register.
 *           - BTF (Byte Transfer Finished) is cleared by software sequence: a
 * read operation to I2C_SATR1 register (I2C_GetFlagStatus()) followed by a
 *             read/write to I2C_DATAR register (I2C_SendData()).
 *           - ADDR (Address sent) is cleared by software sequence: a read
 * operation to I2C_SATR1 register (I2C_GetFlagStatus()) followed by a read
 * operation to I2C_SATR2 register ((void)(I2Cx->STAR2)).
 *           - SB (Start Bit) is cleared software sequence: a read operation to
 * I2C_STAR1 register (I2C_GetFlagStatus()) followed by a write operation to
 ...
 *          Note-
 *           - STOPF (STOP detection) is cleared by software sequence: a read
 * operation to I2C_STAR1 register (I2C_GetITStatus()) followed by a write
 * operation to I2C_CTLR1 register (I2C_Cmd() to re-enable the I2C peripheral).
 *           - ADD10 (10-bit header sent) is cleared by software sequence: a
 * read operation to I2C_STAR1 (I2C_GetITStatus()) followed by writing the
 * second byte of the address in I2C_DATAR register.
 *           - BTF (Byte Transfer Finished) is cleared by software sequence: a
 * read operation to I2C_STAR1 register (I2C_GetITStatus()) followed by a
 *             read/write to I2C_DATAR register (I2C_SendData()).
 *           - ADDR (Address sent) is cleared by software sequence: a read
 * operation to I2C_STAR1 register (I2C_GetITStatus()) followed by a read
 * operation to I2C_STAR2 register ((void)(I2Cx->STAR2)).
 *           - SB (Start Bit) is cleared by software sequence: a read operation

/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32x035.h Author : WCH
 * Version            : V1.0.2
 * Date               : 2025/03/10
...
#define __STDPERIPH_VERSION                                                    \
	((__STDPERIPH_VERSION_MAIN << 8) | (__STDPERIPH_VERSION_SUB << 0))
 ...
 * ********************/
#define ADC_AWDCH                                                              \
	((uint32_t)0x0000000F) /* AWDCH[3:0] bits (Analog watchdog channel     \
				  select bits) */
...
#define ADC_DISCNUM                                                            \
	((uint32_t)0x0000E000) /* DISCNUM[2:0] bits (Discontinuous mode        \
				  channel count) */
...
#define ADC_JEXTTRIG                                                           \
	((uint32_t)0x00008000) /* External Trigger Conversion mode for         \
				  injected channels */
...
#define ADC_L                                                                  \
	((uint32_t)0x00F00000) /* L[3:0] bits (Regular channel sequence        \
				  length) */
...
#define ADC_CTLR3_AWD_SCAN                                                     \
	((uint32_t)0x00000200) /* Analog watchdog Scan enable */
#define ADC_CTLR3_AWD0_RST_EN                                                  \
	((uint32_t)0x00001000) /* Watchdog0 Reset Enable */
#define ADC_CTLR3_AWD1_RST_EN                                                  \
	((uint32_t)0x00002000) /* Watchdog1 Reset Enable */
#define ADC_CTLR3_AWD2_RST_EN                                                  \
	((uint32_t)0x00004000) /* Watchdog2 Reset Enable */
#define ADC_CTLR3_AWD3_RST_EN                                                  \
	((uint32_t)0x00008000) /* Watchdog3 Reset Enable */

/********************  Bit definition for ADC_WDTR1 register
 * ********************/
#define ADC_WDTR1_LTR1                                                         \
	((uint32_t)0x00000FFF) /* Analog watchdog1 low threshold */
#define ADC_WDTR1_HTR1                                                         \
	((uint32_t)0x0FFF0000) /* Analog watchdog1 high threshold */

/********************  Bit definition for ADC_WDTR2 register
 * ********************/
#define ADC_WDTR2_LTR2                                                         \
	((uint32_t)0x00000FFF) /* Analog watchdog2 low threshold */
#define ADC_WDTR2_HTR2                                                         \
	((uint32_t)0x0FFF0000) /* Analog watchdog2 high threshold */

/********************  Bit definition for ADC_WDTR3 register
 * ********************/
#define ADC_WDTR3_LTR3                                                         \
	((uint32_t)0x00000FFF) /* Analog watchdog3 low threshold */
#define ADC_WDTR3_HTR3                                                         \
	((uint32_t)0x0FFF0000) /* Analog watchdog3 high threshold */
...
#define DMA_TCIF8                                                              \
	((uint32_t)0x20000000)		 /* Channel 8 Transfer Complete flag   \
					  */
...
#define DMA_CGIF8                                                              \
	((uint32_t)0x10000000) /* Channel 8 Global interrupt clear             \
				*/
#define DMA_CTCIF8                                                             \
	((uint32_t)0x20000000) /* Channel 8 Transfer Complete clear */
...
#define EXTI_INTENR_MR10                                                       \
	((uint32_t)0x00000400) /* Interrupt Mask on line 10                    \
				*/
#define EXTI_INTENR_MR11                                                       \
	((uint32_t)0x00000800) /* Interrupt Mask on line 11                    \
				*/
#define EXTI_INTENR_MR12                                                       \
	((uint32_t)0x00001000) /* Interrupt Mask on line 12                    \
				*/
#define EXTI_INTENR_MR13                                                       \
	((uint32_t)0x00002000) /* Interrupt Mask on line 13                    \
				*/
#define EXTI_INTENR_MR14                                                       \
	((uint32_t)0x00004000) /* Interrupt Mask on line 14                    \
				*/
#define EXTI_INTENR_MR15                                                       \
	((uint32_t)0x00008000) /* Interrupt Mask on line 15                    \
				*/
#define EXTI_INTENR_MR16                                                       \
	((uint32_t)0x00010000) /* Interrupt Mask on line 16                    \
				*/
#define EXTI_INTENR_MR17                                                       \
	((uint32_t)0x00020000) /* Interrupt Mask on line 17                    \
				*/
#define EXTI_INTENR_MR18                                                       \
	((uint32_t)0x00040000) /* Interrupt Mask on line 18                    \
				*/
#define EXTI_INTENR_MR19                                                       \
	((uint32_t)0x00080000) /* Interrupt Mask on line 19                    \
				*/
#define EXTI_INTENR_MR20                                                       \
	((uint32_t)0x00100000) /* Interrupt Mask on line 20                    \
				*/
#define EXTI_INTENR_MR21                                                       \
	((uint32_t)0x00200000) /* Interrupt Mask on line 21                    \
				*/
#define EXTI_INTENR_MR22                                                       \
	((uint32_t)0x00400000) /* Interrupt Mask on line 22                    \
				*/
#define EXTI_INTENR_MR23                                                       \
	((uint32_t)0x00800000) /* Interrupt Mask on line 23                    \
				*/
#define EXTI_INTENR_MR24                                                       \
	((uint32_t)0x01000000) /* Interrupt Mask on line 24                    \
				*/
#define EXTI_INTENR_MR25                                                       \
	((uint32_t)0x02000000) /* Interrupt Mask on line 25                    \
				*/
#define EXTI_INTENR_MR26                                                       \
	((uint32_t)0x04000000) /* Interrupt Mask on line 26                    \
				*/
#define EXTI_INTENR_MR27                                                       \
	((uint32_t)0x08000000) /* Interrupt Mask on line 27                    \
				*/
#define EXTI_INTENR_MR28                                                       \
	((uint32_t)0x10000000) /* Interrupt Mask on line 28                    \
				*/
#define EXTI_INTENR_MR29                                                       \
	((uint32_t)0x20000000) /* Interrupt Mask on line 29                    \
				*/
...
#define EXTI_RTENR_TR19                                                        \
	((uint32_t)0x00080000) /* Rising trigger event configuration bit of    \
				  line 19 */
#define EXTI_RTENR_TR20                                                        \
	((uint32_t)0x00100000) /* Rising trigger event configuration bit of    \
				  line 20 */
#define EXTI_RTENR_TR21                                                        \
	((uint32_t)0x00200000) /* Rising trigger event configuration bit of    \
				  line 21 */
#define EXTI_RTENR_TR22                                                        \
	((uint32_t)0x00400000) /* Rising trigger event configuration bit of    \
				  line 22 */
#define EXTI_RTENR_TR23                                                        \
	((uint32_t)0x00800000) /* Rising trigger event configuration bit of    \
				  line 23 */
#define EXTI_RTENR_TR24                                                        \
	((uint32_t)0x01000000) /* Rising trigger event configuration bit of    \
				  line 24 */
#define EXTI_RTENR_TR25                                                        \
	((uint32_t)0x02000000) /* Rising trigger event configuration bit of    \
				  line 25 */
#define EXTI_RTENR_TR26                                                        \
	((uint32_t)0x04000000) /* Rising trigger event configuration bit of    \
				  line 26 */
#define EXTI_RTENR_TR27                                                        \
	((uint32_t)0x08000000) /* Rising trigger event configuration bit of    \
				  line 27 */
#define EXTI_RTENR_TR28                                                        \
	((uint32_t)0x10000000) /* Rising trigger event configuration bit of    \
				  line 28 */
#define EXTI_RTENR_TR29                                                        \
	((uint32_t)0x20000000) /* Rising trigger event configuration bit of    \
				  line 29 */
...
#define EXTI_FTENR_TR19                                                        \
	((uint32_t)0x00080000) /* Falling trigger event configuration bit of   \
				  line 19 */
#define EXTI_FTENR_TR20                                                        \
	((uint32_t)0x00100000) /* Falling trigger event configuration bit of   \
				  line 20 */
#define EXTI_FTENR_TR21                                                        \
	((uint32_t)0x00200000) /* Falling trigger event configuration bit of   \
				  line 21 */
#define EXTI_FTENR_TR22                                                        \
	((uint32_t)0x00400000) /* Falling trigger event configuration bit of   \
				  line 22 */
#define EXTI_FTENR_TR23                                                        \
	((uint32_t)0x00800000) /* Falling trigger event configuration bit of   \
				  line 23 */
#define EXTI_FTENR_TR24                                                        \
	((uint32_t)0x01000000) /* Falling trigger event configuration bit of   \
				  line 24 */
#define EXTI_FTENR_TR25                                                        \
	((uint32_t)0x02000000) /* Falling trigger event configuration bit of   \
				  line 25 */
#define EXTI_FTENR_TR26                                                        \
	((uint32_t)0x04000000) /* Falling trigger event configuration bit of   \
				  line 26 */
#define EXTI_FTENR_TR27                                                        \
	((uint32_t)0x08000000) /* Falling trigger event configuration bit of   \
				  line 27 */
#define EXTI_FTENR_TR28                                                        \
	((uint32_t)0x10000000) /* Falling trigger event configuration bit of   \
				  line 28 */
#define EXTI_FTENR_TR29                                                        \
	((uint32_t)0x20000000) /* Falling trigger event configuration bit of   \
				  line 29 */
...
#define EXTI_SWIEVR_SWIEVR20                                                   \
	((uint32_t)0x00100000) /* Software Interrupt on line 20 */
#define EXTI_SWIEVR_SWIEVR21                                                   \
	((uint32_t)0x00200000) /* Software Interrupt on line 21 */
#define EXTI_SWIEVR_SWIEVR22                                                   \
	((uint32_t)0x00400000) /* Software Interrupt on line 22 */
#define EXTI_SWIEVR_SWIEVR23                                                   \
	((uint32_t)0x00800000) /* Software Interrupt on line 23 */
#define EXTI_SWIEVR_SWIEVR24                                                   \
	((uint32_t)0x01000000) /* Software Interrupt on line 24 */
#define EXTI_SWIEVR_SWIEVR25                                                   \
	((uint32_t)0x02000000) /* Software Interrupt on line 25 */
#define EXTI_SWIEVR_SWIEVR26                                                   \
	((uint32_t)0x04000000) /* Software Interrupt on line 26 */
#define EXTI_SWIEVR_SWIEVR27                                                   \
	((uint32_t)0x08000000) /* Software Interrupt on line 27 */
#define EXTI_SWIEVR_SWIEVR28                                                   \
	((uint32_t)0x10000000) /* Software Interrupt on line 28 */
#define EXTI_SWIEVR_SWIEVR29                                                   \
	((uint32_t)0x20000000) /* Software Interrupt on line 29 */
...
#define FLASH_STATR_BOOT_STATUS                                                \
	((uint16_t)0x2000) /* The source of Execute Program */
#define FLASH_STATR_BOOT_MODE                                                  \
	((uint16_t)0x4000) /* The switch of user section or boot section*/
...
#define FLASH_CTLR_OBWRE                                                       \
	((uint32_t)0x00000200)			/* Option Bytes Write Enable   \
						 */
 ...
 * ******************/
#define FLASH_MODEKEYR_MODEKEYR                                                \
	((uint32_t)0xFFFFFFFF) /* Open fast program /erase */
...
#define AFIO_PCFR1_SPI1_REMAP                                                  \
	((uint32_t)0x00000003) /* SPI1_REMAP[1:0] bits (SPI1 remapping) */
#define AFIO_PCFR1_SPI1_REMAP_0 ((uint32_t)0x00000001) /* Bit 0 */
#define AFIO_PCFR1_SPI1_REMAP_1 ((uint32_t)0x00000002) /* Bit 1 */

#define AFIO_PCFR1_I2C1_REMAP                                                  \
	((uint32_t)0x0000001C) /* I2C1_REMAP[4:2] bits (I2C1 remapping) */
...
#define AFIO_PCFR1_USART1_REMAP                                                \
	((uint32_t)0x00000060) /* USART1_REMAP[6:5] bits (USART1 remapping) */
#define AFIO_PCFR1_USART1_REMAP_0 ((uint32_t)0x00000020) /* Bit 0 */
#define AFIO_PCFR1_USART1_REMAP_1 ((uint32_t)0x00000040) /* Bit 1 */

#define AFIO_PCFR1_USART2_REMAP                                                \
	((uint32_t)0x00000380) /* USART2_REMAP[9:7] bits (USART2 remapping) */
...
#define AFIO_PCFR1_USART3_REMAP                                                \
	((uint32_t)0x00000C00) /* USART3_REMAP[11:10] bits (USART3 remapping)  \
				*/
#define AFIO_PCFR1_USART3_REMAP_0 ((uint32_t)0x00000400) /* Bit 0 */
#define AFIO_PCFR1_USART3_REMAP_1 ((uint32_t)0x00000800) /* Bit 1 */

#define AFIO_PCFR1_USART4_REMAP                                                \
	((uint32_t)0x00007000) /* USART4_REMAP[14:12] bits (USART4 remapping)  \
				*/
...
#define AFIO_PCFR1_TIM1_REMAP                                                  \
	((uint32_t)0x00038000) /* TIM1_REMAP[17:15] bits (TIM1 remapping) */
...
#define AFIO_PCFR1_TIM2_REMAP                                                  \
	((uint32_t)0x001C0000) /* TIM2_REMAP[20:18] bits (TIM2 remapping) */
...
#define AFIO_PCFR1_TIM3_REMAP                                                  \
	((uint32_t)0x00600000) /* TIM3_REMAP[22:21] bits (TIM3 remapping) */
#define AFIO_PCFR1_TIM3_REMAP_0 ((uint32_t)0x00200000) /* Bit 0 */
#define AFIO_PCFR1_TIM3_REMAP_1 ((uint32_t)0x00400000) /* Bit 1 */

#define AFIO_PCFR1_PIOC_REMAP                                                  \
	((uint32_t)0x00800000) /* PIOC[23] bits (PIOC remapping) */
 ...
 * ********************/
#define AFIO_CTLR_UDM_PUE                                                      \
	((uint32_t)0x00000003)			   /* PC16/UDM Pin pull-up     \
						      Mode*/
#define AFIO_CTLR_UDM_PUE_0 ((uint32_t)0x00000001) /* bit[0] */
#define AFIO_CTLR_UDM_PUE_1 ((uint32_t)0x00000002) /* bit[1] */

#define AFIO_CTLR_UDP_PUE                                                      \
	((uint32_t)0x0000000C)			   /* PC17/UDP Pin pull-up     \
						      Mode*/
#define AFIO_CTLR_UDP_PUE_0 ((uint32_t)0x00000004) /* bit[2] */
#define AFIO_CTLR_UDP_PUE_1 ((uint32_t)0x00000008) /* bit[3] */

#define AFIO_CTLR_USB_PHY_V33                                                  \
	((uint32_t)0x00000040) /* USB transceiver PHY output and pull-up       \
				  limiter configuration */
#define AFIO_CTLR_USB_IOEN ((uint32_t)0x00000080) /* USB Remap pin enable */
#define AFIO_CTLR_USBPD_PHY_V33                                                \
	((uint32_t)0x00000100) /* USBPD transceiver PHY output and pull-up     \
				  limiter configuration */
#define AFIO_CTLR_USBPD_IN_HVT                                                 \
	((uint32_t)0x00000200) /* PD pin PC14/PC15 high threshold input mode   \
				*/
#define AFIO_CTLR_UDP_BC_VSRC                                                  \
	((uint32_t)0x00010000) /* PC17/UDP pin BC protocol source voltage      \
				  enable */
#define AFIO_CTLR_UDM_BC_VSRC                                                  \
	((uint32_t)0x00020000) /* PC16/UDM pin BC protocol source voltage      \
				  enable */
#define AFIO_CTLR_UDP_BC_CMPO                                                  \
	((uint32_t)0x00040000) /* PC17/UDP pin BC protocol comparator status   \
				*/
#define AFIO_CTLR_UDM_BC_CMPO                                                  \
	((uint32_t)0x00080000) /* PC16/UDM pin BC protocol comparator status   \
				*/
#define AFIO_CTLR_PA3_FILT_EN                                                  \
	((uint32_t)0x01000000) /* Controls the input filtering of the PA3 pin  \
				*/
#define AFIO_CTLR_PA4_FILT_EN                                                  \
	((uint32_t)0x02000000) /* Controls the input filtering of the PA4 pin  \
				*/
#define AFIO_CTLR_PB5_FILT_EN                                                  \
	((uint32_t)0x04000000) /* Controls the input filtering of the PB5 pin  \
				*/
#define AFIO_CTLR_PB6_FILT_EN                                                  \
	((uint32_t)0x08000000) /* Controls the input filtering of the PB6 pin  \
				*/
...
#define PWR_CTLR_PLS                                                           \
	((uint16_t)0x0060) /* PLS[2:0] bits (PVD Level Selection) */
...
#define PWR_CTLR_LP_REG                                                        \
	((uint16_t)0x0200) /* Software configure flash into lower energy mode  \
			    */
...
#define SPI_HSCR_HSRXEN                                                        \
	((uint16_t)0x0001) /* Read Enable under SPI High speed mode */
...
#define TIM_CMP_BK                                                             \
	((uint16_t)0x1000) /* voltage comparator break enable, TIM1 only */
...
#define TIM_SPEC_PWM_EN_1_2                                                    \
	((uint16_t)0x0001) /* Channel 1 and Channel 2 alternate */
#define TIM_SPEC_PWM_EN_3_4                                                    \
	((uint16_t)0x0002) /* Channel 3 and Channel 4 alternate */
#define TIM_SPEC_PWM_OC1                                                       \
	((uint16_t)0x0010) /* Channel 1 invalid level under alternate mode */
#define TIM_SPEC_PWM_OC2                                                       \
	((uint16_t)0x0020) /* Channel 2 invalid level under alternate mode */
#define TIM_SPEC_PWM_OC3                                                       \
	((uint16_t)0x0040) /* Channel 3 invalid level under alternate mode */
#define TIM_SPEC_PWM_OC4                                                       \
	((uint16_t)0x0080) /* Channel 4 invalid level under alternate mode */

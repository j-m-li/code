/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32x035_dma.h Author :
...
typedef struct {
	uint32_t DMA_PeripheralBaseAddr; /* Specifies the peripheral base
					    address for DMAy Channelx. */

	uint32_t DMA_MemoryBaseAddr; /* Specifies the memory base address for
					DMAy Channelx. */
	...
	uint32_t
	    DMA_BufferSize; /* Specifies the buffer size, in data unit, of the
	...
	uint32_t
	    DMA_MemoryInc; /* Specifies whether the memory address register is
	...
	uint32_t DMA_Mode; /* Specifies the operation mode of the DMAy Channelx.
			      ...
			      the memory-to-memory data transfer is configured
			      on the selected Channel */

	uint32_t DMA_Priority; /* Specifies the software priority for the DMAy
				  Channelx. This parameter can be a value of

...
project_new -overwrite -revision cod5 cod5

set_global_assignment -name VERILOG_FILE ../common/src/async_fifo.v
set_global_assignment -name VERILOG_FILE ../common/src/c5_adder.v
set_global_assignment -name VERILOG_FILE ../common/src/c5_alu.v
set_global_assignment -name VERILOG_FILE ../common/src/c5_bus_mux.v
set_global_assignment -name VERILOG_FILE ../common/src/c5_control.v
set_global_assignment -name VERILOG_FILE ../common/src/c5_cpu.v
set_global_assignment -name VERILOG_FILE ../common/src/c5_increment.v
set_global_assignment -name VERILOG_FILE ../common/src/c5_inc.v
set_global_assignment -name VERILOG_FILE ../common/src/c5_mem_ctrl.v
set_global_assignment -name VERILOG_FILE ../common/src/c5_mult.v
set_global_assignment -name VERILOG_FILE ../common/src/c5_negate.v
set_global_assignment -name VERILOG_FILE ../common/src/c5_pc_next.v
set_global_assignment -name VERILOG_FILE ../common/src/c5_pipeline.v
set_global_assignment -name VERILOG_FILE ../common/src/c5_ram.v
set_global_assignment -name VERILOG_FILE ../common/src/c5_reg_bank.v
set_global_assignment -name VERILOG_FILE ../common/src/c5_shifter.v
set_global_assignment -name VERILOG_FILE ../common/src/display.v
set_global_assignment -name VERILOG_FILE ../common/src/soc.v
set_global_assignment -name VERILOG_FILE ../common/src/sdcard.v
set_global_assignment -name VERILOG_FILE ../common/src/spi_master.v
set_global_assignment -name VERILOG_FILE ../common/src/tmds_encoder.v
set_global_assignment -name VERILOG_FILE ../common/src/uart.v
set_global_assignment -name VERILOG_FILE src/mem_pll.v
set_global_assignment -name VERILOG_FILE src/hdmi_pll.v
set_global_assignment -name VERILOG_FILE src/gpdi.v
set_global_assignment -name VERILOG_FILE src/sdram.v
set_global_assignment -name VERILOG_FILE src/cod5_top.v

set_global_assignment -name TOP_LEVEL_ENTITY cod5_top

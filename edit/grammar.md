...
expressionName: varName ('.' varName)?
    | expressionName '.' methodCall
    | expressionName '[' expression ']'
    | className '.' varName
    | className '.' methodCall
    | 

methodCall: methodName '(' expressionList ')'

assignTerm: expressionName assingOp expression

postfixTerm: expressionName postfixOp

prefixTerm: prefixOp expressionName

callTerm: expressionName '(' expressionList ')'

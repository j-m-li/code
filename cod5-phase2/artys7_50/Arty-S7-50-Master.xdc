...
# PMOD FPGA board front view :
#
# VCC GND   4  3  2  1
# VCC GND  10  9  8  7
# ---------------------

## PMOD Header JA : GPDI video 
set_property -dict { PACKAGE_PIN L17   IOSTANDARD TMDS_33 } [get_ports { O_tmds_data_p[2] }]; #IO_L4P_T0_D04_14 Sch=ja_p[1] pin1
set_property -dict { PACKAGE_PIN L18   IOSTANDARD TMDS_33 } [get_ports { O_tmds_data_n[2] }]; #IO_L4N_T0_D05_14 Sch=ja_n[1] pin2
set_property -dict { PACKAGE_PIN M14   IOSTANDARD TMDS_33 } [get_ports { O_tmds_data_p[1] }]; #IO_L5P_T0_D06_14 Sch=ja_p[2] pin3
set_property -dict { PACKAGE_PIN N14   IOSTANDARD TMDS_33 } [get_ports { O_tmds_data_n[1] }]; #IO_L5N_T0_D07_14 Sch=ja_n[2] pin4
set_property -dict { PACKAGE_PIN M16   IOSTANDARD TMDS_33 } [get_ports { O_tmds_data_p[0]  }]; #IO_L7P_T1_D09_14 Sch=ja_p[3] pin7
set_property -dict { PACKAGE_PIN M17   IOSTANDARD TMDS_33 } [get_ports { O_tmds_data_n[0] }]; #IO_L7N_T1_D10_14 Sch=ja_n[3] pin8
set_property -dict { PACKAGE_PIN M18   IOSTANDARD TMDS_33 } [get_ports { O_tmds_clk_p }]; #IO_L8P_T1_D11_14 Sch=ja_p[4] pin9
set_property -dict { PACKAGE_PIN N18    IOSTANDARD TMDS_33 } [get_ports { O_tmds_clk_n }]; #IO_L8N_T1_D12_14 Sch=ja_n[4] pin10
